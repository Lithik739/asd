...
this.initiateTTS(
    this.props.rout.params.story.title,
   this.props.rout.params.story.title.author,
   this.props.rout.params.story.title.story,
   this.props.rout.params.story.title.moral,
